package xyz.tag.repository;

import xyz.tag.JhipsterApp;
import xyz.tag.config.Constants;
import xyz.tag.config.audit.AuditEventConverter;
import xyz.tag.domain.PersistentAuditEvent;
...
import static xyz.tag.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
